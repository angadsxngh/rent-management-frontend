...
export default function PaymentRequest() {
  ...
  return (
    <main className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-6">
      <h1 className="text-2xl sm:text-3xl font-bold text-indigo-700">Settle Up</h1>
      <p className="text-gray-600 text-sm sm:text-base">Submit a payment for your rented property.</p>
